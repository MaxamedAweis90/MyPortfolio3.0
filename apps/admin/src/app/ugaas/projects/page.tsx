...
import { Switch } from "@portfolio/ui";
  ...
  const filteredProjects = useMemo(() => {
    return projects.filter((project) => {
      ...
      const searchMatch =
        ...
        project.tools?.some((t: string) => t.toLowerCase().includes(q));
  ...
  return (
    <div className="space-y-8">
      ...
      <ProjectDialog
        ...
        onSuccess={(savedProject: any, isNew?: boolean) => {
          handleProjectSaved(savedProject, isNew ?? false);
          fetchCategories();
        }}
