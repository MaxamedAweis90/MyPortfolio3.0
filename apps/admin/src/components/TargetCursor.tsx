...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      if (
        directTarget &&
        (directTarget.closest("nav") ||
          directTarget.closest("header") ||
          directTarget.closest(".navbar") ||
          directTarget.closest("input") ||
          directTarget.closest("textarea") ||
          directTarget.closest("select"))
      ) {
