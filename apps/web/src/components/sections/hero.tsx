...
const Hero = ({ settings }: HeroProps = {}) => {
  ...
  const [resumeUrl, setResumeUrl] = useState(
    settings?.resumeUrl || appContextData.resume || "/resume.pdf"
  );
  const displayName = settings?.fullName || appContextData.name || "Eng_Aweis";
  ...
  // Listen for client-side real-time updates
  useEffect(() => {
