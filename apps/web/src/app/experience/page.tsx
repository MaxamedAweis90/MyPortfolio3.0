...
export default function ExperiencePage() {
  ...
  useEffect(() => {
    fetch("/api/ugaas/experience", { cache: "no-store" })
      ...
      .then((data) => {
        if (data.success) {
          const careerDocs = (data.experiences || []).filter(
            (e: any) => e.type === "career",
          );
          const eduDocs = (data.experiences || []).filter(
            (e: any) => e.type === "education",
          );

          const sortedCareer = careerDocs.sort(
      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-10">
        ...
        >
          ...
          <p className="text-mutedText text-sm sm:text-base leading-relaxed">
            A comprehensive overview of my software engineering positions,
            internships, university education, and verified certifications.
          </p>
        </motion.div>
          ...
          <div className="flex items-center gap-3 border-b border-borderSubtle/70 pb-4">
            ...
            <div>
              ...
              <p className="text-xs text-mutedText">
                Production web applications, API engineering, and software
                delivery
              </p>
            </div>
          </div>
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-borderSubtle/60 pb-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2.5">
                      ...
                      <span
                        className={`text-xs font-bold px-3 py-1 rounded-xl border ${exp.badgeColor} ${exp.badgeBg}`}
                      >
                        {exp.type}
                      </span>
                    </div>
        ...
        <section id="education" className="space-y-8 pt-6 scroll-mt-28">
          <div className="flex items-center gap-3 border-b border-borderSubtle/70 pb-4">
            ...
            <div>
              ...
              <p className="text-xs text-mutedText">
                Academic foundation in computer science and information
                technology
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-borderSubtle/70 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-mutedText">
                  Verified credentials with interactive image and PDF document
                  previews
                </p>
              </div>
            </div>
        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-surface/90 border border-brandAccent/40 shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          <div className="space-y-1">
            ...
            <p className="text-sm text-mutedText">
              Feel free to reach out for full-time opportunities, contracts, or
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                  {selectedCert.credentialId && (
                    <button
                      type="button"
                      onClick={() =>
                        handleCopyCredential(selectedCert.credentialId)
                      }
