...
const ProjectRequest = () => {
  ...
  return (
    <>
      <section className="py-16 px-4 md:px-10 bg-amber-100" id="project-request" data-aos="fade-in">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <form onSubmit={handleSubmit} className="md:col-span-2 space-y-6 bg-white p-8 rounded-lg shadow" data-aos="fade-right">
              {/* Project Name */}
            ...
            <div className="space-y-6 flex flex-col justify-center gap-4 md:gap-12" data-aos="fade-left">
              {contactItems.map((item, index) => (
                <div key={index} className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-md">{item.value}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          {/* Google Map */}
          <div className="mt-12 p-3 rounded-md bg-white shadow border border-gray-200" data-aos="fade-up">
            <iframe
